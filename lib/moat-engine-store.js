    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          actual_financial_impact: outcome.actualFinancialImpact,
          accuracy_status: outcome.accuracyStatus,
      ...
      await appendSupabaseAudit(supabase, {
        ...
        detail: `${outcome.accuracyStatus} outcome recorded for ${outcome.sku}.`,
      });
