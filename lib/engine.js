...
export function normalizeScenario(rawScenario = {}) {
  return {
    ...defaultScenario,
    ...rawScenario,
    businessType: rawScenario.businessType || defaultScenario.businessType,
    businessScale: rawScenario.businessScale || defaultScenario.businessScale,
    objectiveMode: rawScenario.objectiveMode || defaultScenario.objectiveMode,
    scenarioMode: rawScenario.scenarioMode || defaultScenario.scenarioMode,
    monthlyUnits: finiteNumber(rawScenario.monthlyUnits, defaultScenario.monthlyUnits),
    inventory: finiteNumber(rawScenario.inventory, defaultScenario.inventory),
    leadTime: finiteNumber(rawScenario.leadTime, defaultScenario.leadTime),
    supplierReliability: finiteNumber(
      rawScenario.supplierReliability,
      defaultScenario.supplierReliability,
    ),
    growthRate: finiteNumber(rawScenario.growthRate, defaultScenario.growthRate),
    margin: finiteNumber(rawScenario.margin, defaultScenario.margin),
    cashRunway: finiteNumber(rawScenario.cashRunway, defaultScenario.cashRunway),
    seasonalityIntensity: finiteNumber(
      rawScenario.seasonalityIntensity,
      defaultScenario.seasonalityIntensity,
    ),
    accountConcentration: finiteNumber(
      rawScenario.accountConcentration,
      defaultScenario.accountConcentration,
    ),
    componentCriticality: finiteNumber(
      rawScenario.componentCriticality,
      defaultScenario.componentCriticality,
    ),
    singleSourceRisk: finiteNumber(
      rawScenario.singleSourceRisk,
      defaultScenario.singleSourceRisk,
    ),
    warehouseCount: finiteNumber(rawScenario.warehouseCount, defaultScenario.warehouseCount),
    nodeImbalance: finiteNumber(rawScenario.nodeImbalance, defaultScenario.nodeImbalance),
    launchIntensity: finiteNumber(rawScenario.launchIntensity, defaultScenario.launchIntensity),
  };
}
...
export function buildDecision(rawScenario) {
  ...
  const adjustedGrowthRate = scenario.growthRate + scenarioProfile.growthBoost * 100;
